          ...
          >
            <div>
              ...
              <div className="rounded-xl border border-green-500/15 bg-[#02050b]/80 p-5 font-mono text-sm leading-7 sm:text-base">
                <div className="mb-4 flex items-center justify-between text-xs uppercase tracking-[0.3em] text-green-400/50">
                  ...
                  <span className="text-cyan-400/70">online</span>
                </div>
            ...
            <div className="mt-6 grid gap-3 text-sm text-gray-300 sm:grid-cols-2">
              <div className="rounded-lg border border-green-500/15 bg-green-500/5 p-4">
                <p className="text-xs uppercase tracking-[0.25em] text-green-400/60">enfoque</p>
                <p className="mt-2 text-green-400">Arquitecturas sólidas y producto con impacto real.</p>
              </div>
              <div className="rounded-lg border border-cyan-400/15 bg-cyan-400/5 p-4">
                <p className="text-xs uppercase tracking-[0.25em] text-cyan-400/60">mentalidad</p>
                <p className="mt-2 text-gray-300">Pensamiento sistémico, iteración constante y obsesión por el detalle.</p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="mb-4 flex items-center gap-3 text-green-400">
                <Sparkles size={18} />
                <span className="text-sm uppercase tracking-[0.3em] text-green-400/70">Perfil técnico</span>
              </div>

              <p className="text-base leading-8 text-gray-300 sm:text-lg">
                Full-Stack Developer con sólida experiencia en el ecosistema Java. Me enfoco en transformar
                problemas complejos en soluciones eficientes, escalables y robustas para proyectos de gran
                envergadura. Mi objetivo es aportar valor mediante código limpio y alto rendimiento.
              </p>
            </motion.div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm leading-7 text-gray-300 sm:text-base">
                      <span className="font-medium text-green-400">estado:</span>{' '}
                      {highlight}
                    </p>
                  </div>
                </motion.div>
