...
const translations = {
  en: {
    ...
    description: 'Recommendations from colleagues, managers, and collaborators. Coming soon.',
    badge: 'Under Construction',
  },
  es: {
    title: 'TESTIMONIOS',
    heading: 'Lo Que Dicen',
    description: 'Recomendaciones de compañeros, managers y colaboradores. Próximamente.',
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="relative overflow-hidden px-6 py-16">
        ...
        >
          ...
          <div className="w-full max-w-lg rounded-xl border border-green-500/20 bg-black/40 p-8 backdrop-blur-sm">
            <div className="mb-4 flex items-center justify-center gap-3">
              <MessageSquareQuote className="h-8 w-8 text-green-400/60" />
