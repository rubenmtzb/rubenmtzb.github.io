...
const captions = {
  ...
  crypto: ['Cripto local: cantidades y coste registrado. Se escribe texto sintético y se previsualizan tres posiciones, sin confirmar. Sin cotizaciones, pérdidas y ganancias, carteras conectadas ni operaciones.', 'Local crypto: quantities and recorded cost. Synthetic text is typed and three positions are previewed, without confirmation. No market prices, P&L, connected wallets or trading.'],
